...
{
    internal class SelectMembers : SelectStatements
    {
        public SelectMembers() : base() { }
        ...
        public override string FormatStatement(List<string> searchContents, List<string> searchParameter)
        {
            ...
            for (int i = 0; i < searchContents.Count; i++)
            {
                ...
                if(searchContents[i].ToLower().Equals("memberid") || searchContents[i].ToLower().Equals("streetnumber") || searchContents[i].ToLower().Equals("unitnumber") || searchContents[i].ToLower().Equals("postcode"))
                {
